...
contract ABC is ERC20Burnable, ERC20Memo, AccessControlEnumerable, ERC20Permit, ERC20Votes
{
    bytes32 public constant MINTER_ROLE = keccak256("MINTER_ROLE");
    bytes32 public constant BURNER_ROLE = keccak256("BURNER_ROLE");
    

    constructor(address _admin) ERC20("%%TOKEN_NAME%%", "%%TOKEN_SYMBOL%%") ERC20Permit("%%TOKEN_SYMBOL%%")
    {
